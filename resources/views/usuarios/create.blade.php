...
<div class="card" style="margin:20px;">
    <div class="card-header">Agregar un nuevo usuario</div>
    <div class="card-body">
        ...
        <form action="{{ url('usuarios')}}" method="post">
            ...
            <input type="number" name="telefono" id="telefono" class="form-control"></br>
            <label>Rol</label></br>
            <input type="number" name="rol" id="rol" class="form-control">
            <label>Contraseña</label></br>
            <input type="password" name="password" id="password" class="form-control" placeholder="Inserte Su contraseña"></br>
            </br>
