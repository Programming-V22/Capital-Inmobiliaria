...
<div class="card-header">Edit Visitas</div>
    <div class="card-body">
        

    <form action="{{ url('visitas/' .$lista_visita->id) }}" method="post">
            {!! csrf_field() !!}
                @method("PATCH")
            ...
            <select class="form-select" aria-label="Default select example" name="id_inmueble" id="id_inmueble">
                ...
                <option value="{{$inmuebl->id}}">{{$inmuebl->id}}&nbsp&nbsp{{$inmuebl->titulo}}</option>
                @endforeach
            </select></br>
            ...
            <select class="form-select" aria-label="Default select example"  name="id_cliente"  id="id_cliente" onchange="cliente();">
                ...
                <option value="{{$cliente->id}}">{{$cliente->id}}&nbsp&nbsp{{$cliente->nombre}}</option>
